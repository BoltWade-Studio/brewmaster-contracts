...
sozo execute --world $WORLD_ADDRESS $SYSTEM_ADDRESS updateMaxScale -c 10,10 --rpc-url $RPC_URL --account-address $OWNER_ADDRESS --private-key $OWNER_PK --wait
echo "Update max scale success."