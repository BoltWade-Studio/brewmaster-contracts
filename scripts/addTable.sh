...
sozo execute --world $WORLD_ADDRESS $SYSTEM_ADDRESS addTable --account-address $OTHER_PLAYER_ADDRESS --private-key $OTHER_PLAYER_PK --wait

echo "Add new table success with player $OTHER_PLAYER_ADDRESS."